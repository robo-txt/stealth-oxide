...
third-party security system. They are ignored by default because they require
Chromium and may need network access or a compatible desktop environment.

Run one diagnostic with a local Chromium installation:
